...
export function parseScore(raw) {
  ...
  // A missing or empty reason is treated as a hard failure too: the agent
  // cannot act on "the reviewer gave no feedback", so failing closed is
  // safer than pretending we know what to fix.
  ...
  return Object.freeze({ score, reason })
}
